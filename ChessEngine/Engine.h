...
class Engine {
    ...
    int seconds;
    pair<Move, double> negamax(State& state, int depth, bool quiescence);
    double negamax(State& state, int currentDepth, int depth, double alpha, double beta, bool quiescence);
